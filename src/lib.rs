...
//! bits of the payload via closures which are called in response to SAX parsing events. (Because *let's face it*, JSON
//! payloads usually come burdened with a whole load of unnecessary crap that you'll never use).
//!
